        ...
        <div className="flex justify-center">
          <Card className="w-full max-w-md">
            <CardContent className="p-6">
              ...
              <div className="mb-4">
                <label className="mb-2 block text-sm font-medium text-foreground">Reason for refund (optional)</label>
                <Textarea
                  value={reason}
              ...
              <div className="flex gap-3">
                ...
                <Button className="flex-1 bg-purple-600 text-white hover:bg-purple-700">Submit Refund</Button>
              </div>
            </CardContent>
          </Card>
        </div>
